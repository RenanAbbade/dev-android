...
class GuestDataBaseHelper(context: Context) :
    ...
    companion object {
        private const val DATABASE_VERSION =
            1 //DATABASE VERSION MUDA EM VERSÕES POSTERIORES DO APP PARA COMPORTAR ANTIGOS E NOVOS USUÁRIOS E SUAS RESPECTIVAS BD, GERENCIADOS PELO SISTEMA DO ANDROID.
